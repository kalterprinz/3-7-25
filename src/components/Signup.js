...
const Signup = () => {
  ...
  const handleDriverSignup = async (e) => {
    ...
    submissionData.append("DLIssue", DLIssue);
    submissionData.append("DLExpireDate", DLExpireDate);
    ...
    try {
      const response = await axios.post("http://192.168.1.32:3001/signup", submissionData, {
