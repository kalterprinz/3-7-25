...
import { faArrowUpAZ, faCab,faArrowUpZA, faXmark, faFilter, faMapLocation,faEllipsisH, faFloppyDisk, faMagnifyingGlass, faPen, faRectangleList, faTicket, faTrashCan, faUserPlus, faAdd, faMoneyBill, faMoneyBill1, faMoneyBill1Wave, faCertificate, faDownload } from '@fortawesome/free-solid-svg-icons';
...
const handleFineUpdate = async (recordId) => {
  ...
  const handleCsvData = (data) => {
    console.log("CSV Data:", data); // Log to check parsed data
    setRecords(data); // Save CSV data in state

    console.log("Final Data Sent to Backend:", JSON.stringify(data, null, 2));
    fetchRecords();
...
const handleDelete = async (recordId) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const recordData = {
      ...
      nameOfDriver: formState.nameOfDriver,
      placeOfViolation: formState.placeOfViolation,
      timeOfApprehension: fullDateTime,
      dateOfApprehension: formState.dateOfApprehension,
      vehicleClassification: formState.vehicleClassification,
      violationDes: formState.violationDes,
      violationType: Array.isArray(formState.violationType) ? formState.violationType.join(',') : "",
      gender: formState.gender,
      age: formState.age,
      fineStatus: fineStatus,
      apprehendingOfficer: formState.apprehendingOfficer,
      ...
      licenseClassification: formState.licenseClassification,
      ...
      vehicleOwnerName: formState.vehicleOwnerName,
      vehicleOwnerAddress: formState.vehicleOwnerAddress,
      fineAmount: formState.fineAmount,
      dueDate: dueDate.toISOString(),
      oRNo:formState.oRNo,
      datepaid:formState.datepaid,
        ...
        if (response.status === 201) {
          ...
          const formatDateTime = (dateObj) => {
                    ...
                    if (isValidEmail(recordData.email)) {
                      const formattedTime = formatDateTime(recordData.timeOfApprehension);
                      const formattedDue = formatDueDate(recordData.dueDate);
    ...
    return (
          ...
          <div className="page">
            ...
            <div className="insidepage">
              ...
              <div className="titleview">
                ...
                <p>BJT-North, Tambo, Hinaplanon, Iligan City</p>
              </div>
      ...
      <table className="details-table123">
        ...
        <tbody>
          <tr>
            <td>
              {ictpmoRecord.nameOfDriver || "N/A"} <br />
                      ...
                      <td>
                        <div className="buttonsof">
                          <button className="edit-button" onClick={() => handleEdit(records)}>
                            ...
                            <button className="paid-button" onClick={() => handlePaid(records)}>
                              <FontAwesomeIcon icon={faMoneyBill1Wave} style={{ color: "#fff" }} />
                            </button>
                            <button
              ...
              <label htmlFor="fine-status">Fine Status <span style={{ color: 'red' }}>*</span></label>
               ...
               <div className="form-groupovr">
                ...
                <div className="modal-buttons">
                  {selectedData ? (
                      <button type="submit" onClick={handleUpdate} className="submitadd">
                        Update Record <FontAwesomeIcon icon={faFloppyDisk} style={{color: "#ffffff", marginLeft:"10"}} />
                      </button>
                    ) : (
                      <button type="submit" onClick={handleSubmit} className="submitadd">
                        Add Record <FontAwesomeIcon icon={faUserPlus} style={{color: "#ffffff", marginLeft:"10"}} />
                      </button>
                    )}
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="add-formovr">
          <div className="paidModal"> 
            <label htmlFor="ORno">Enter Official Receipt(OR) Number: <span style={{ color: 'red' }}>*</span></label>
            <input 
              id="ORno" 
              type="text" 
              ...
              required 
            />
            <label htmlFor="Date-paid">Enter Date Paid: <span style={{ color: 'red' }}>*</span></label>
            <input 
              id="Date-paid" 
              type="date" 
            ...
            />
            <div className="modal-buttons">
              <button type="submit"  onClick={handlePaidUpdate} className="submitadd">Update Record <FontAwesomeIcon icon={faFloppyDisk} style={{color: "#ffffff", marginLeft:"10"}} /></button>
              <button type="button" className="close-modal-btn" onClick={closeModal}>Cancel <FontAwesomeIcon icon={faXmark} style={{color: "#ffffff", marginLeft:"10"}} /> </button>
            </div>
          </div>
        </form>
