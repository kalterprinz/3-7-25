...
//       anchor: 'end',
//       align: 'start',
//       formatter: (value) => value, // show 9, 2, etc.
//       color: '#000',
//       font: {
//         weight: 'bold',
//         size: 12,
...
const genderChartData = {
  labels: ['Male', 'Female'], // x-axis categories
  datasets: [
    {
      label: 'Male', // ✅ this appears in the legend
      data: [genderData.Male, 0], // Example: [50, 30] for male and female counts
      backgroundColor:'#4e73df',
      borderColor: '#4e73df',
      borderWidth: 1,
    },
    {
      label: 'Female', // ✅ this appears in the legend
      data: [0, genderData.Female], // Example: [50, 30] for male and female counts
...
const genderChartOptions = {
  plugins: {
    legend: {
      display: true, // 👈 Hides the legend above the chart
    },
    datalabels: {
...
//       label: 'Fine Status',
//       data: fineStatusData, 
//       backgroundColor: ['#1cc855', '#df4e4e'],
//       borderColor: ['#1cc855', '#df4e4e'],
//       borderWidth: 1,
//     },
//   ],
// };
...
const fineStatusChartData = {
  ...
  datasets: [
    {
      label: 'Paid',
      data: [fineStatusData.Paid, 0], // referencing by key
    ...
    {
      label: 'Unpaid',
      data: [0, fineStatusData.Unpaid], // referencing by key
...
const fetchClearances = useCallback(async () => {
  try {
    const response = await fetch("http://192.168.1.32:3001/getClearances");
          ...
          <h2>Clearances Printed Over Time</h2>
            <div className="filters1">
              ...
              <div className="clearance-summary">
                  <h3>Summary</h3>
                  <p>
                    <strong>&emsp;&emsp; {printedThisMonth} clearances</strong> are printred this month of <strong>{currentMonthName}</strong>.
                  </p>
              </div> 
          </div>  
        </div>
